...
- **Fold-variance replication: mediawiki swung 0.000 -> 0.243 -> 0.083 across three near-identical trainings — re-run 2-3 folds N times (varied seed/data order) to put error bars on the rotation before crediting or blaming any future lever; folds whose delta is inside the noise band prove nothing** — added 2026-07-25.
